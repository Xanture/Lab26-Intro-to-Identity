...
namespace lab26_brian.Models
{
    ...
    {
        private readonly lab26_brianContext _context;

        public CMSController(lab26_brianContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var cMS = await _context.CMS.SingleOrDefaultAsync(m => m.CustomerID == id);
            if (cMS == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.CMS.Any(e => e.CustomerID == id);
        }
    }
}
